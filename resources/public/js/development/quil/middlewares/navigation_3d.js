...
var vec__32131 = axis;
var a_x = cljs.core.nth.call(null,vec__32131,(0),null);
var a_y = cljs.core.nth.call(null,vec__32131,(1),null);
var a_z = cljs.core.nth.call(null,vec__32131,(2),null);
var vec__32134 = v;
var x = cljs.core.nth.call(null,vec__32134,(0),null);
var y = cljs.core.nth.call(null,vec__32134,(1),null);
var z = cljs.core.nth.call(null,vec__32134,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__32137,p__32138){
var vec__32139 = p__32137;
var u1 = cljs.core.nth.call(null,vec__32139,(0),null);
var u2 = cljs.core.nth.call(null,vec__32139,(1),null);
var u3 = cljs.core.nth.call(null,vec__32139,(2),null);
var vec__32142 = p__32138;
var v1 = cljs.core.nth.call(null,vec__32142,(0),null);
var v2 = cljs.core.nth.call(null,vec__32142,(1),null);
var v3 = cljs.core.nth.call(null,vec__32142,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__32145_SHARP_){
return (p1__32145_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__32146_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__32147_SHARP_,angle_lr),angle_ud);
...
var map__32149 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__32149__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__32149__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5455__auto__ = (function (){var pred__32151 = cljs.core._EQ_;
var expr__32152 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__32151.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__32152))){
return straight;
} else {
if(cljs.core.truth_(pred__32151.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__32152))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__32151.call(null,quil.middlewares.navigation_3d.space,expr__32152))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__32151.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__32152))){
return up;
} else {
if(cljs.core.truth_(pred__32151.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__32152))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__32151.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__32152))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5455__auto__,map__32149,map__32149__$1,up,straight){
return (function (p1__32148_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__32148_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5455__auto__,map__32149,map__32149__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__32154_SHARP_);
});})(initial_state))
);
});
/**
...
var map__32155_32166 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__32155_32167__$1 = ((((!((map__32155_32166 == null)))?((((map__32155_32166.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__32155_32166.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__32155_32166):map__32155_32166);
var vec__32156_32168 = cljs.core.get.call(null,map__32155_32167__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_32169 = cljs.core.nth.call(null,vec__32156_32168,(0),null);
var c_y_32170 = cljs.core.nth.call(null,vec__32156_32168,(1),null);
var c_z_32171 = cljs.core.nth.call(null,vec__32156_32168,(2),null);
var vec__32159_32172 = cljs.core.get.call(null,map__32155_32167__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_32173 = cljs.core.nth.call(null,vec__32159_32172,(0),null);
var u_y_32174 = cljs.core.nth.call(null,vec__32159_32172,(1),null);
var u_z_32175 = cljs.core.nth.call(null,vec__32159_32172,(2),null);
var vec__32162_32176 = cljs.core.get.call(null,map__32155_32167__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_32177 = cljs.core.nth.call(null,vec__32162_32176,(0),null);
var p_y_32178 = cljs.core.nth.call(null,vec__32162_32176,(1),null);
var p_z_32179 = cljs.core.nth.call(null,vec__32162_32176,(2),null);
quil.core.camera.call(null,p_x_32177,p_y_32178,p_z_32179,(p_x_32177 + c_x_32169),(p_y_32178 + c_y_32170),(p_z_32179 + c_z_32171),u_x_32173,u_y_32174,u_z_32175);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1526486794023
