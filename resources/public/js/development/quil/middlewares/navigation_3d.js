...
var vec__11023 = axis;
var a_x = cljs.core.nth.call(null,vec__11023,(0),null);
var a_y = cljs.core.nth.call(null,vec__11023,(1),null);
var a_z = cljs.core.nth.call(null,vec__11023,(2),null);
var vec__11026 = v;
var x = cljs.core.nth.call(null,vec__11026,(0),null);
var y = cljs.core.nth.call(null,vec__11026,(1),null);
var z = cljs.core.nth.call(null,vec__11026,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__11029,p__11030){
var vec__11031 = p__11029;
var u1 = cljs.core.nth.call(null,vec__11031,(0),null);
var u2 = cljs.core.nth.call(null,vec__11031,(1),null);
var u3 = cljs.core.nth.call(null,vec__11031,(2),null);
var vec__11034 = p__11030;
var v1 = cljs.core.nth.call(null,vec__11034,(0),null);
var v2 = cljs.core.nth.call(null,vec__11034,(1),null);
var v3 = cljs.core.nth.call(null,vec__11034,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__11037_SHARP_){
return (p1__11037_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__11038_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__11039_SHARP_,angle_lr),angle_ud);
...
var map__11041 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__11041__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__11041__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5455__auto__ = (function (){var pred__11043 = cljs.core._EQ_;
var expr__11044 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__11043.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__11044))){
return straight;
} else {
if(cljs.core.truth_(pred__11043.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__11044))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__11043.call(null,quil.middlewares.navigation_3d.space,expr__11044))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__11043.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__11044))){
return up;
} else {
if(cljs.core.truth_(pred__11043.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__11044))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__11043.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__11044))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5455__auto__,map__11041,map__11041__$1,up,straight){
return (function (p1__11040_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__11040_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5455__auto__,map__11041,map__11041__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__11046_SHARP_);
});})(initial_state))
);
});
/**
...
var map__11047_11058 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__11047_11059__$1 = ((((!((map__11047_11058 == null)))?((((map__11047_11058.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11047_11058.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11047_11058):map__11047_11058);
var vec__11048_11060 = cljs.core.get.call(null,map__11047_11059__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_11061 = cljs.core.nth.call(null,vec__11048_11060,(0),null);
var c_y_11062 = cljs.core.nth.call(null,vec__11048_11060,(1),null);
var c_z_11063 = cljs.core.nth.call(null,vec__11048_11060,(2),null);
var vec__11051_11064 = cljs.core.get.call(null,map__11047_11059__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_11065 = cljs.core.nth.call(null,vec__11051_11064,(0),null);
var u_y_11066 = cljs.core.nth.call(null,vec__11051_11064,(1),null);
var u_z_11067 = cljs.core.nth.call(null,vec__11051_11064,(2),null);
var vec__11054_11068 = cljs.core.get.call(null,map__11047_11059__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_11069 = cljs.core.nth.call(null,vec__11054_11068,(0),null);
var p_y_11070 = cljs.core.nth.call(null,vec__11054_11068,(1),null);
var p_z_11071 = cljs.core.nth.call(null,vec__11054_11068,(2),null);
quil.core.camera.call(null,p_x_11069,p_y_11070,p_z_11071,(p_x_11069 + c_x_11061),(p_y_11070 + c_y_11062),(p_z_11071 + c_z_11063),u_x_11065,u_y_11066,u_z_11067);
