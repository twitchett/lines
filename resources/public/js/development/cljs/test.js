...
var G__33385 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__33385,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__33385;
}
});
...
var or__30083__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__31362__auto___33390 = arguments.length;
var i__31363__auto___33391 = (0);
while(true){
if((i__31363__auto___33391 < len__31362__auto___33390)){
args__31369__auto__.push((arguments[i__31363__auto___33391]));

var G__33392 = (i__31363__auto___33391 + (1));
i__31363__auto___33391 = G__33392;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__31370__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq33387){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__33388,G__33389,seq33387__$2);
});
...
var file = cljs.core.get.call(null,map__33394__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__33394__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__33394__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__33394,map__33394__$1,file,line,column){
return (function (p1__33393_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__33393_SHARP_));
});})(map__33394,map__33394__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__31138__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__31138__auto__,prefer_table__31139__auto__,method_cache__31140__auto__,cached_hierarchy__31141__auto__,hierarchy__31142__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__30083__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__30083__auto__)){
return or__30083__auto__;
} else {
...
var temp__5457__auto___33396 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___33396)){
var message_33397 = temp__5457__auto___33396;
cljs.core.println.call(null,message_33397);
} else {
}
...
var temp__5457__auto___33398 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___33398)){
var message_33399 = temp__5457__auto___33398;
cljs.core.println.call(null,message_33399);
} else {
}
...
var output_dir = "resources/public/js/development";
var output_dir__$1 = (function (){var G__33400 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__33400),"/"].join('');
} else {
return G__33400;
}
})();
...
var temp__5455__auto__ = (function (){var and__30071__auto__ = typeof exception.stack === 'string';
if(and__30071__auto__){
var G__33402 = exception.stack;
var G__33402__$1 = (((G__33402 == null))?null:clojure.string.split_lines.call(null,G__33402));
var G__33402__$2 = (((G__33402__$1 == null))?null:cljs.core.get.call(null,G__33402__$1,depth));
if((G__33402__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__33402__$2);
}
} else {
...
var vec__33403 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__33403,(0),null);
var column = cljs.core.nth.call(null,vec__33403,(1),null);
var vec__33406 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__33406,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__33406,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__33406,(2),null);
...
var m__$1 = (function (){var G__33409 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__33413 = (function (){var G__33412 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__33412);
} else {
return G__33412;
}
})();
...
return cljs.core.vary_meta.call(null,G__33414,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__33418 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__33418,(0),null);
var types = vec__33418;
...
return cljs.core.map.call(null,(function (p__33421){
var vec__33422 = p__33421;
var ns = cljs.core.nth.call(null,vec__33422,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__33422,(1),null);
return ((function (vec__33422,ns,vars__$1){
return (function (){
...
var G__33425 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__33425__$1 = (((G__33425 instanceof cljs.core.Keyword))?G__33425.fqn:null);
switch (G__33425__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__33425,G__33425__$1,env,once_fixtures,each_fixtures,vec__33422,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__33425,G__33425__$1,env,once_fixtures,each_fixtures,vec__33422,ns,vars__$1){
return (function (){
var seq__33426 = cljs.core.seq.call(null,vars__$1);
var chunk__33427 = null;
var count__33428 = (0);
var i__33429 = (0);
while(true){
if((i__33429 < count__33428)){
var v = cljs.core._nth.call(null,chunk__33427,i__33429);
var temp__5457__auto___33431 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___33431)){
var t_33432 = temp__5457__auto___33431;
each_fixture_fn.call(null,((function (seq__33426,chunk__33427,count__33428,i__33429,t_33432,temp__5457__auto___33431,v,each_fixture_fn,G__33425,G__33425__$1,env,once_fixtures,each_fixtures,vec__33422,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_33432)));
});})(seq__33426,chunk__33427,count__33428,i__33429,t_33432,temp__5457__auto___33431,v,each_fixture_fn,G__33425,G__33425__$1,env,once_fixtures,each_fixtures,vec__33422,ns,vars__$1))
);
} else {
}

var G__33433 = seq__33426;
var G__33434 = chunk__33427;
var G__33435 = count__33428;
var G__33436 = (i__33429 + (1));
seq__33426 = G__33433;
chunk__33427 = G__33434;
count__33428 = G__33435;
i__33429 = G__33436;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__33426);
if(temp__5457__auto__){
var seq__33426__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__33426__$1)){
var c__31014__auto__ = cljs.core.chunk_first.call(null,seq__33426__$1);
var G__33437 = cljs.core.chunk_rest.call(null,seq__33426__$1);
var G__33438 = c__31014__auto__;
var G__33439 = cljs.core.count.call(null,c__31014__auto__);
var G__33440 = (0);
seq__33426 = G__33437;
chunk__33427 = G__33438;
count__33428 = G__33439;
i__33429 = G__33440;
continue;
} else {
var v = cljs.core.first.call(null,seq__33426__$1);
var temp__5457__auto___33441__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___33441__$1)){
var t_33442 = temp__5457__auto___33441__$1;
each_fixture_fn.call(null,((function (seq__33426,chunk__33427,count__33428,i__33429,t_33442,temp__5457__auto___33441__$1,v,seq__33426__$1,temp__5457__auto__,each_fixture_fn,G__33425,G__33425__$1,env,once_fixtures,each_fixtures,vec__33422,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_33442)));
});})(seq__33426,chunk__33427,count__33428,i__33429,t_33442,temp__5457__auto___33441__$1,v,seq__33426__$1,temp__5457__auto__,each_fixture_fn,G__33425,G__33425__$1,env,once_fixtures,each_fixtures,vec__33422,ns,vars__$1))
);
} else {
}

var G__33443 = cljs.core.next.call(null,seq__33426__$1);
var G__33444 = null;
var G__33445 = (0);
var G__33446 = (0);
seq__33426 = G__33443;
chunk__33427 = G__33444;
count__33428 = G__33445;
i__33429 = G__33446;
continue;
}
} else {
...
});})(each_fixture_fn,G__33425,G__33425__$1,env,once_fixtures,each_fixtures,vec__33422,ns,vars__$1))
);
});})(each_fixture_fn,G__33425,G__33425__$1,env,once_fixtures,each_fixtures,vec__33422,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__33425__$1)].join('')));

}
})());
});
;})(vec__33422,ns,vars__$1))
...
//# sourceMappingURL=test.js.map?rel=1521406485438
