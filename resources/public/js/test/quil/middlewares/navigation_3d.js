...
var vec__11776 = axis;
var a_x = cljs.core.nth.call(null,vec__11776,(0),null);
var a_y = cljs.core.nth.call(null,vec__11776,(1),null);
var a_z = cljs.core.nth.call(null,vec__11776,(2),null);
var vec__11779 = v;
var x = cljs.core.nth.call(null,vec__11779,(0),null);
var y = cljs.core.nth.call(null,vec__11779,(1),null);
var z = cljs.core.nth.call(null,vec__11779,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__11782,p__11783){
var vec__11784 = p__11782;
var u1 = cljs.core.nth.call(null,vec__11784,(0),null);
var u2 = cljs.core.nth.call(null,vec__11784,(1),null);
var u3 = cljs.core.nth.call(null,vec__11784,(2),null);
var vec__11787 = p__11783;
var v1 = cljs.core.nth.call(null,vec__11787,(0),null);
var v2 = cljs.core.nth.call(null,vec__11787,(1),null);
var v3 = cljs.core.nth.call(null,vec__11787,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__11790_SHARP_){
return (p1__11790_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__11791_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__11792_SHARP_,angle_lr),angle_ud);
...
var map__11794 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__11794__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__11794__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5455__auto__ = (function (){var pred__11796 = cljs.core._EQ_;
var expr__11797 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__11796.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__11797))){
return straight;
} else {
if(cljs.core.truth_(pred__11796.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__11797))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__11796.call(null,quil.middlewares.navigation_3d.space,expr__11797))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__11796.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__11797))){
return up;
} else {
if(cljs.core.truth_(pred__11796.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__11797))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__11796.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__11797))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5455__auto__,map__11794,map__11794__$1,up,straight){
return (function (p1__11793_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__11793_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5455__auto__,map__11794,map__11794__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__11799_SHARP_);
});})(initial_state))
);
});
/**
...
var map__11800_11811 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__11800_11812__$1 = ((((!((map__11800_11811 == null)))?((((map__11800_11811.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11800_11811.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11800_11811):map__11800_11811);
var vec__11801_11813 = cljs.core.get.call(null,map__11800_11812__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_11814 = cljs.core.nth.call(null,vec__11801_11813,(0),null);
var c_y_11815 = cljs.core.nth.call(null,vec__11801_11813,(1),null);
var c_z_11816 = cljs.core.nth.call(null,vec__11801_11813,(2),null);
var vec__11804_11817 = cljs.core.get.call(null,map__11800_11812__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_11818 = cljs.core.nth.call(null,vec__11804_11817,(0),null);
var u_y_11819 = cljs.core.nth.call(null,vec__11804_11817,(1),null);
var u_z_11820 = cljs.core.nth.call(null,vec__11804_11817,(2),null);
var vec__11807_11821 = cljs.core.get.call(null,map__11800_11812__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_11822 = cljs.core.nth.call(null,vec__11807_11821,(0),null);
var p_y_11823 = cljs.core.nth.call(null,vec__11807_11821,(1),null);
var p_z_11824 = cljs.core.nth.call(null,vec__11807_11821,(2),null);
quil.core.camera.call(null,p_x_11822,p_y_11823,p_z_11824,(p_x_11822 + c_x_11814),(p_y_11823 + c_y_11815),(p_z_11824 + c_z_11816),u_x_11818,u_y_11819,u_z_11820);
