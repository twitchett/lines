...
var slc = (rngs[(32)]);
var and__8770__auto__ = (slc === (32));
if(and__8770__auto__){
var or__8782__auto__ = (shift === (5));
if(or__8782__auto__){
return or__8782__auto__;
} else {
var G__10513 = (root.arr[(slc - (1))]);
var G__10514 = (shift - (5));
var G__10515 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__10513;
shift = G__10514;
cnt = G__10515;
continue;
...
var rngs_10524 = clojure.core.rrb_vector.nodes.ranges.call(null,parent);
var rng0_10525 = (rngs_10524[(0)]);
var new_rngs_10526 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_10527 = (rngs_10524[(32)]);
cljs.core.array_copy.call(null,rngs_10524,(1),new_rngs_10526,(0),(lim_10527 - (1)));

var i_10528 = (0);
while(true){
if((i_10528 < lim_10527)){
(new_rngs_10526[i_10528] = ((new_rngs_10526[i_10528]) - rng0_10525));
...
(new_rngs_10526[(32)] = ((rngs_10524[(32)]) - (1)));

(new_rngs_10526[((rngs_10524[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_10526);
} else {
}
...
while(true){
if((i_10530 <= li)){
(new_rngs[i_10530] = ((new_rngs[(i_10530 - (1))]) + step));
...
while(true){
if((i_10532 <= li)){
(new_rngs[i_10532] = ((rngs[i_10532]) - d));
...
while(true){
if((j_10534 <= i)){
(rngs[j_10534] = r_10535);

var G__10536 = (j_10534 + (1));
var G__10537 = (r_10535 + step);
j_10534 = G__10536;
r_10535 = G__10537;
continue;
} else {
...
var rngs = ((!(reg_QMARK_))?(function (){var G__10538 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__10538[(0)] = node.arr.length);
...
var arr_10539__$1 = arr;
var shift_10540__$1 = shift;
while(true){
if((shift_10540__$1 === (5))){
if(!(reg_QMARK_)){
(arr_10539__$1[(32)] = rngs);
} else {
}

(arr_10539__$1[(0)] = node);
} else {
var a_10541 = (new Array(len));
var e_10542 = cljs.core.__GT_VectorNode.call(null,null,a_10541);
(arr_10539__$1[(0)] = e_10542);
...
var G__10543 = a_10541;
var G__10544 = (shift_10540__$1 - (5));
arr_10539__$1 = G__10543;
shift_10540__$1 = G__10544;
continue;
}
break;
}
...
var reg_QMARK_ = (function (){var and__8770__auto__ = clojure.core.rrb_vector.nodes.regular_QMARK_.call(null,node);
