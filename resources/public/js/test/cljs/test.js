...
var G__11219 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11219,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11219;
}
});
...
var or__8148__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__9427__auto___11224 = arguments.length;
var i__9428__auto___11225 = (0);
while(true){
if((i__9428__auto___11225 < len__9427__auto___11224)){
args__9434__auto__.push((arguments[i__9428__auto___11225]));

var G__11226 = (i__9428__auto___11225 + (1));
i__9428__auto___11225 = G__11226;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__9435__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11221){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__11222,G__11223,seq11221__$2);
});
...
var file = cljs.core.get.call(null,map__11228__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11228__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11228__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__11228,map__11228__$1,file,line,column){
return (function (p1__11227_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11227_SHARP_));
});})(map__11228,map__11228__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__9203__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__9203__auto__,prefer_table__9204__auto__,method_cache__9205__auto__,cached_hierarchy__9206__auto__,hierarchy__9207__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__8148__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__8148__auto__)){
return or__8148__auto__;
} else {
...
var temp__5457__auto___11230 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___11230)){
var message_11231 = temp__5457__auto___11230;
cljs.core.println.call(null,message_11231);
} else {
}
...
var temp__5457__auto___11232 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___11232)){
var message_11233 = temp__5457__auto___11232;
cljs.core.println.call(null,message_11233);
} else {
}
...
var output_dir = "resources/public/js/test";
var output_dir__$1 = (function (){var G__11234 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11234),"/"].join('');
} else {
return G__11234;
}
})();
...
var temp__5455__auto__ = (function (){var and__8136__auto__ = typeof exception.stack === 'string';
if(and__8136__auto__){
var G__11236 = exception.stack;
var G__11236__$1 = (((G__11236 == null))?null:clojure.string.split_lines.call(null,G__11236));
var G__11236__$2 = (((G__11236__$1 == null))?null:cljs.core.get.call(null,G__11236__$1,depth));
if((G__11236__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11236__$2);
}
} else {
...
var vec__11237 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11237,(0),null);
var column = cljs.core.nth.call(null,vec__11237,(1),null);
var vec__11240 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11240,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11240,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11240,(2),null);
...
var m__$1 = (function (){var G__11243 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__11247 = (function (){var G__11246 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11246);
} else {
return G__11246;
}
})();
...
return cljs.core.vary_meta.call(null,G__11248,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__11252 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11252,(0),null);
var types = vec__11252;
...
return cljs.core.map.call(null,(function (p__11255){
var vec__11256 = p__11255;
var ns = cljs.core.nth.call(null,vec__11256,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11256,(1),null);
return ((function (vec__11256,ns,vars__$1){
return (function (){
...
var G__11259 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__11259,G__11259__$1,env,once_fixtures,each_fixtures,vec__11256,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__11259,G__11259__$1,env,once_fixtures,each_fixtures,vec__11256,ns,vars__$1){
return (function (){
var seq__11260 = cljs.core.seq.call(null,vars__$1);
var chunk__11261 = null;
var count__11262 = (0);
var i__11263 = (0);
while(true){
if((i__11263 < count__11262)){
var v = cljs.core._nth.call(null,chunk__11261,i__11263);
var temp__5457__auto___11265 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___11265)){
var t_11266 = temp__5457__auto___11265;
each_fixture_fn.call(null,((function (seq__11260,chunk__11261,count__11262,i__11263,t_11266,temp__5457__auto___11265,v,each_fixture_fn,G__11259,G__11259__$1,env,once_fixtures,each_fixtures,vec__11256,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11266)));
});})(seq__11260,chunk__11261,count__11262,i__11263,t_11266,temp__5457__auto___11265,v,each_fixture_fn,G__11259,G__11259__$1,env,once_fixtures,each_fixtures,vec__11256,ns,vars__$1))
);
} else {
}

var G__11267 = seq__11260;
var G__11268 = chunk__11261;
var G__11269 = count__11262;
var G__11270 = (i__11263 + (1));
seq__11260 = G__11267;
chunk__11261 = G__11268;
count__11262 = G__11269;
i__11263 = G__11270;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__11260);
if(temp__5457__auto__){
var seq__11260__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11260__$1)){
var c__9079__auto__ = cljs.core.chunk_first.call(null,seq__11260__$1);
var G__11271 = cljs.core.chunk_rest.call(null,seq__11260__$1);
var G__11272 = c__9079__auto__;
var G__11273 = cljs.core.count.call(null,c__9079__auto__);
var G__11274 = (0);
seq__11260 = G__11271;
chunk__11261 = G__11272;
count__11262 = G__11273;
i__11263 = G__11274;
continue;
} else {
var v = cljs.core.first.call(null,seq__11260__$1);
var temp__5457__auto___11275__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___11275__$1)){
var t_11276 = temp__5457__auto___11275__$1;
each_fixture_fn.call(null,((function (seq__11260,chunk__11261,count__11262,i__11263,t_11276,temp__5457__auto___11275__$1,v,seq__11260__$1,temp__5457__auto__,each_fixture_fn,G__11259,G__11259__$1,env,once_fixtures,each_fixtures,vec__11256,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11276)));
});})(seq__11260,chunk__11261,count__11262,i__11263,t_11276,temp__5457__auto___11275__$1,v,seq__11260__$1,temp__5457__auto__,each_fixture_fn,G__11259,G__11259__$1,env,once_fixtures,each_fixtures,vec__11256,ns,vars__$1))
);
} else {
}

var G__11277 = cljs.core.next.call(null,seq__11260__$1);
var G__11278 = null;
var G__11279 = (0);
var G__11280 = (0);
seq__11260 = G__11277;
chunk__11261 = G__11278;
count__11262 = G__11279;
i__11263 = G__11280;
continue;
}
} else {
...
});})(each_fixture_fn,G__11259,G__11259__$1,env,once_fixtures,each_fixtures,vec__11256,ns,vars__$1))
);
});})(each_fixture_fn,G__11259,G__11259__$1,env,once_fixtures,each_fixtures,vec__11256,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11259__$1)].join('')));

}
})());
});
;})(vec__11256,ns,vars__$1))
